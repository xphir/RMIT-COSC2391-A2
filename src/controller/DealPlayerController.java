...
public class DealPlayerController implements ActionListener
{
	...
	public DealPlayerController(CardGameFrame cardGameFrame, GameEngine model)
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		new Thread()
		{
			...
			public void run()
			{
				// Validating that a player is selected and a bet is placed for them before rolling for the player.
				if (cardGameFrame.getPlayerPanel().getSelectPlayer().getSelectedItem() == null)
				{
					JOptionPane.showMessageDialog(cardGameFrame, "Error: Please select a player and place a bet before dealing a hand for the Player.");
				}
