...
public class IteratorTest
{
	...
	{
		// there is no Array[] constructor for ArrayList as usual in Java we can find a way :)
		// NOTE: if we didn't consrtuct a new ArrayList and simply assigned the return it would be a fixed sized List
