...
import sadi.topic5.layout.SimpleJFrame;
      ...
      openItem.addActionListener(new ActionListener()
      {
         public void actionPerformed(ActionEvent e)
         {
            if (fileSelection.showOpenDialog(JMenuBarDemo.this) == JFileChooser.APPROVE_OPTION)
               JOptionPane.showMessageDialog(JMenuBarDemo.this, "Open file selected was " + fileSelection
      ...
      saveItem.addActionListener(new ActionListener()
      {
         public void actionPerformed(ActionEvent e)
         {
            if (fileSelection.showSaveDialog(JMenuBarDemo.this) == JFileChooser.APPROVE_OPTION)
               JOptionPane.showMessageDialog(JMenuBarDemo.this, "Save file selected was " + fileSelection
                  .getSelectedFile().getPath());
         }
      });
