...
public class GameEngineCallbackImpl implements GameEngineCallback
{
   ...
   public void nextCard(Player player, PlayingCard card, GameEngine engine)
   {
      ...
      logger.log(Level.FINE, String.format("Card Dealt to %s .. Suit: %s, Value: %s, Score: %d",player.getPlayerName(),card.getSuit(),card.getValue(),card.getScore()));
   }
   ...
   public void result(Player player, int result, GameEngine engine)
   {
      ...
      logger.log(Level.INFO, String.format("The Loser, final result=%d", result));
   }
   ...
   {
      // intermediate results logged at Level.FINE
      logger.log(Level.FINE, String.format("Card Dealt to %s .. Suit: %s, Value: %s, Score: %d ... YOU BUSTED!",player.getPlayerName(),card.getSuit(),card.getValue(),card.getScore()));
   }
   ...
   {
      // intermediate results logged at Level.FINE
      logger.log(Level.FINE, String.format("Card Dealt to House .. Suit: %s, Value: %s, Score: %d ... YOU BUSTED!",card.getSuit(),card.getValue(),card.getScore()));
   }
   ...
   {
      // intermediate results logged at Level.FINE
      logger.log(Level.FINE, String.format("Card Dealt to House .. Suit: %s, Value: %s, Score: %d",card.getSuit(),card.getValue(),card.getScore()));
   }
